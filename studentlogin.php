...
<div>
  <nav class="mb-1 navbar navbar-expand-lg navbar-dark unique-color">
      ...
      <ul class="nav navbar-nav">
         <li ><a class="nav-link waves-effect waves-light" href="studenthome.php">Home</a></li>
          <li ><a class="nav-link waves-effect waves-light" href="studentnews.php">News</a></li>
          <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle waves-effect waves-light" id="navbarDropdownMenuLink-5" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">Curriculum Vitae</a>
      ...
      <ul class="nav navbar-nav navbar-right">
              ...
              <div class="dropdown-menu dropdown-menu-right dropdown-cyan" aria-labelledby="navbarDropdownMenuLink-4">
                <a class="dropdown-item waves-effect waves-light" href="studentprofile.php">My account</a>
